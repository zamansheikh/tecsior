...
/**
 * PLACEHOLDER content — client names, titles, summaries, bodies, and
 * metrics below are invented for the design demo. Cover images are
 * royalty-free Unsplash photos. Replace each entry (or edit live via
 * the admin panel) before public launch.
 */
...
// PLACEHOLDER bodies — written as design demo. Replace via the admin
// panel or edit this seed before public launch.
...
export const SEED_USERS: User[] = [
  ...
  { id: "u-03", name: "Aria Mahmud", email: "aria@tecsior.com", role: "Editor", lastActive: "1h ago", initials: "AM" },
  { id: "u-04", name: "Sadia Karim", email: "sadia@tecsior.com", role: "Editor", lastActive: "3h ago", initials: "SK" },
  { id: "u-05", name: "Tahsin Rahman", email: "tahsin@tecsior.com", role: "Author", lastActive: "Yesterday", initials: "TR" },
  { id: "u-06", name: "Junaid Ali", email: "junaid@tecsior.com", role: "Viewer", lastActive: "2d ago", initials: "JA" },
];
